...
export const vi = {
  ...
  "settings.aiOn": "AI đang bật ✨",
  "settings.aiOff": "Đang dùng chế độ mẫu (fallback) — chưa có khoá API.",
  "settings.aiHint": "Thêm API key của nhà cung cấp đã chọn vào .env hoặc lưu trong phần này.",
  ...
  "deck.aiNoteAi": "Đã điền bằng AI ✨",
  "deck.aiNoteError": "AI chưa trả kết quả: {detail}",
  "deck.aiNoteFallback":
    "Đã điền bằng bản mẫu (AI chưa trả về kết quả; kiểm tra API key và model).",
  ...
  "review.gradePrompt": "Bạn nhớ từ này ở mức nào?",
  "review.grade.again": "Học lại",
  "review.grade.againHint": "Chưa nhớ",
  "review.grade.hard": "Khó",
  "review.grade.hardHint": "Nhớ chưa chắc",
  "review.grade.good": "Tốt",
  "review.grade.goodHint": "Nhớ được",
  "review.grade.easy": "Dễ",
  "review.grade.easyHint": "Nhớ rất chắc",
...
export const en: Record<TKey, string> = {
  ...
  "settings.aiOn": "AI is on ✨",
  "settings.aiOff": "Using fallback mode — no API key set.",
  "settings.aiHint": "Add the selected provider's API key in .env or save it here.",
  ...
  "deck.aiNoteAi": "Filled by AI ✨",
  "deck.aiNoteError": "AI did not return a result: {detail}",
  "deck.aiNoteFallback":
    "Filled with a template (AI did not return a result; check the API key and model).",
  ...
  "review.gradePrompt": "How well did you remember this word?",
  "review.grade.again": "Again",
  "review.grade.againHint": "Forgot it",
  "review.grade.hard": "Hard",
  "review.grade.hardHint": "Needed effort",
  "review.grade.good": "Good",
  "review.grade.goodHint": "Remembered",
  "review.grade.easy": "Easy",
  "review.grade.easyHint": "Instant recall",
